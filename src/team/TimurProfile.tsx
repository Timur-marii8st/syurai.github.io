      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-end mb-20 border-b border-white/10 pb-10">
          <div className="relative group">
            ...
            <div className="absolute -bottom-4 -right-4 bg-amber-600 text-black font-black uppercase text-xs px-4 py-1 rounded-full border border-black shadow-lg whitespace-nowrap">
                {t.timur.founderBadge}
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-4 text-sm font-bold text-gray-500">
                ...
                <a href="https://github.com/Timur-marii8st" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/5 hover:border-amber-500/50 hover:text-white transition-colors">
                    <Github size={14} /> GitHub
                </a>
                <a href="https://drive.google.com/file/d/1eyXqbGstkaMxQT4B3WtU0BuUfMVTxJOL/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/5 hover:border-amber-500/50 hover:text-white transition-colors">
                    <FileText size={14} /> {t.timur.resumeLabel}
                </a>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
            ...
            <div className="md:col-span-1 space-y-4">
                <h3 className="text-sm font-bold uppercase tracking-widest text-gray-500 mb-4">{t.timur.competenciesTitle}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            ...
            <div className="group bg-gradient-to-br from-white/5 to-transparent border border-white/10 p-8 rounded-3xl relative overflow-hidden">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">{t.timur.researchCardTitle}</h3>
                <p className="text-amber-500 text-xs font-bold uppercase tracking-widest mb-6">{t.timur.researchCardTag}</p>

                <ul className="space-y-6">
                    <li>
                        <div className="text-white font-bold text-lg mb-1 group-hover:text-amber-300 transition-colors">{t.timur.research1Title}</div>
                        <p className="text-sm text-gray-400">
                            {t.timur.research1Desc}
                        </p>
                    </li>
                    <li>
                        <div className="text-white font-bold text-lg mb-1 group-hover:text-amber-300 transition-colors">{t.timur.research2Title}</div>
                        <p className="text-sm text-gray-400">
                            {t.timur.research2Desc}
                        </p>
                    </li>
                </ul>
            </div>
            ...
            <div className="group bg-gradient-to-br from-white/5 to-transparent border border-white/10 p-8 rounded-3xl relative overflow-hidden">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">{t.timur.engineeringCardTitle}</h3>
                <p className="text-blue-500 text-xs font-bold uppercase tracking-widest mb-6">{t.timur.engineeringCardTag}</p>

                <ul className="space-y-6">
                    <li>
                        <div className="text-white font-bold text-lg mb-1 group-hover:text-blue-300 transition-colors">{t.timur.engineering1Title}</div>
                        <p className="text-sm text-gray-400">
                            {t.timur.engineering1Desc}
                        </p>
                    </li>
                    <li>
                        <div className="text-white font-bold text-lg mb-1 group-hover:text-blue-300 transition-colors">{t.timur.engineering2Title}</div>
                        <p className="text-sm text-gray-400">
                            {t.timur.engineering2Desc}
                        </p>
                    </li>
                </ul>
            </div>
        ...
        <div className="border border-white/10 rounded-2xl p-6 flex items-center gap-6 bg-[#050505]">
            ...
            <div>
                <h4 className="text-white font-bold text-lg">{t.timur.communityTitle}</h4>
                <p className="text-gray-500 text-sm">
                    {t.timur.communityDesc}
                </p>
            </div>
        </div>
